...
const GltfMetallicRoughness = struct {
    ...
    // const layout_config: descriptor.Layout.Config = .{};
    // layout_config.add_binding(0,vk.c.VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER);
    // layout_config.add_binding(1, vk.c.VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER);
    // layout_config.add_binding(2, vk.c.VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER);
    //
    //
    //
    //
